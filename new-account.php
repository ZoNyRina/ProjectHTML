...
<html>
    ...
    <body>
        <br>
        <br>
        <h2 class=textfornewcomer>Bonjour <?=$gender_sent?> <?=$lastname_sent?>!! L'Inscription pour un nouveau compte est gratuit !!</h2>
        <br>
        <br>
        ...
        <br>
        <br>
        <form action="send-emailnewaccount.php">
            <div class="newaccountdiv">
                <br>
        Veuillez entrer votre adresse mail pour continuer l'inscription
                ...
                <ul>
                <li><a href="index.php" class="dejauncompt">Vous avez déjà un compte ?</a></li>
                </ul>
            </div>
